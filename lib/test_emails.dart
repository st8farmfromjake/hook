...
sendEmail({int? emailNum, String? emailAdd = 'wolly0305@icloud.com', String? name = 'Mufasa', String? fromName = 'Your mom', String? companyName = 'Hook'}) async {
  ...
  <p>Please go to <a href="https://novusomni.com/hook/">this website</a>, so we can control your computer and help you download this update.</p>
  <p>Thank you,</p>
  <p>IT Department</p>
  '''; break;
  case 3: html = '''
  ...
  <p>Chuck</p>
  <p><a href="https://novusomni.com/hook/">Needed files.</a></p>
  '''; break;
  case 4: html = '''
  ...
  case 5: html = '''
  <p>Dear $name,</p>
  <p>We have recently detected suspicious activity on your account. To ensure the security of your information, we kindly ask you to confirm your personal details by clicking the link below and <a href="https://novusomni.com/hook/">logging into your account.</a></p>
  ...
  case 6: html = '''
  <p>Hello $name,</p>
  <p>Congratulations! You've entered and won a company wide raffle! Click <a href="https://novusomni.com/hook/">this link</a> to claim your 2 day cruise through the Bahamas!</p>
  <p>Congratulations,</p>
  <p>$name</p>
  '''; break;
  case 7: html = '''
  ...
  <p>1. Navigate to the following website: [insert link here]. This is the secure company portal where you can download the latest version of the software. Ensure that you are accessing the website from a secure and company-approved device.</p>
